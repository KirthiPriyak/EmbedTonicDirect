...
window.onload = function() {
    ...
    script.onload = function() {
        ...
        else
        {
          ...
          for (var i = 0; i < scripts.length; i++) { //scripts.length
            ...
            if( scriptElem.indexOf("//embed.tonicdirect.com/player/") >= 0){
                ...
                if( scriptElem != "http://embed.tonicdirect.com/player/js/jquery.js" && scriptElem != "http://embed.tonicdirect.com/player/player/jwplayer.js"){
                  ...
                  //scriptTag = scripts[scripts.length - i];
                  scriptTag = scripts[i];                  
                  var parentTag = scriptTag.parentNode;
                  $(parentTag).append("<div id=" + newDivElement + "><img src=" + baseUrl + "/images/loading.gif /></div>");
